...
def test_format_staged_files_success(mock_run_isort, mock_run_black, mock_get_staged_files):
    mock_get_staged_files.return_value = ["file1.py", "file2.py"]
...
@patch("gac.formatting.formatters.run_black")
@patch("gac.formatting.formatters.run_isort")
def test_format_staged_files_no_files(mock_run_isort, mock_run_black, mock_get_staged_files):
    mock_get_staged_files.return_value = []
    result = format_staged_files()
    assert result is False
...
@patch("gac.formatting.formatters.run_black")
@patch("gac.formatting.formatters.run_isort")
def test_format_staged_files_black_fails(mock_run_isort, mock_run_black, mock_get_staged_files):
    mock_get_staged_files.return_value = ["file1.py", "file2.py"]
