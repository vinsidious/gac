...
def read_file_content(file_path: str) -> Optional[str]:
    ...
    Returns:
        File content as a string, or None if the file doesn't exist or can't be read
    """
    try:
...
def compose(f: Callable[[R], T], g: Callable[..., R]) -> Callable[..., T]:
    """
    Compose two functions.

    Args:
        f: Function that takes the output of g
        g: Function that provides input to f
